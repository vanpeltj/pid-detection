...
from schemas.pid_files import pid_files as Schemapid_files
from schemas.pid_files import pid_filesCreate as Schemapid_filesCreate
from schemas.pid_files import pid_filesUpdate as Schemapid_filesUpdate
from schemas.pid_files import pid_filesUpsert as Schemapid_filesUpsert
from schemas.jobs import jobsCreate as Schemajobs
from data.jobs import jobs
from data.pid_files import pid_files
from sqlalchemy.orm import Session
from sqlalchemy.ext.declarative import DeclarativeMeta as Model

from models.pid_files import pid_files as Modelpid_files
...
model_router = SentoRouter(
    schema=Schemapid_files,
    db=get_db,
    prefix="pid_files",
    db_model=Modelpid_files,
    create_schema=Schemapid_filesCreate,
    update_schema=Schemapid_filesUpdate,
    upsert_schema=Schemapid_filesUpsert,
...
@model_router.post("/process", response_model=Schemajobs)
def process(file_id: int, db: Session = Depends(get_db)) -> Schemajobs:
    f = pid_files.from_id(file_id, db)
    if not f:
